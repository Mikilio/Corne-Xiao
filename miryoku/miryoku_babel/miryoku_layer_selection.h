...
#if !defined(MIRYOKU_LAYER_PAD)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_NAV_INVERTEDT)
      #define MIRYOKU_LAYER_PAD MIRYOKU_ALTERNATIVES_PAD_INVERTEDT_FLIP
    #else
      #define MIRYOKU_LAYER_PAD MIRYOKU_ALTERNATIVES_PAD_FLIP
    #endif
  #else
    #if defined (MIRYOKU_NAV_INVERTEDT)
      #define MIRYOKU_LAYER_PAD MIRYOKU_ALTERNATIVES_PAD_INVERTEDT
    #elif defined (MIRYOKU_NAV_VI)
      #define MIRYOKU_LAYER_PAD MIRYOKU_ALTERNATIVES_PAD_VI
    #else
      #define MIRYOKU_LAYER_PAD MIRYOKU_ALTERNATIVES_PAD
    #endif
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_PAD)
  #define MIRYOKU_LAYERMAPPING_PAD MIRYOKU_MAPPING
#endif
